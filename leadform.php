<?php
/*
Plugin Name: Lead Form by NotifyVisitors
Plugin URI: https://www.notifyvisitors.com/product/lead-form
...
{
    die("leadForm requires WordPress 3.0 or above. <a target='_blank' href='http://codex.wordpress.org/Upgrading_WordPress'>Please update!</a>");
}
// END - Version check
...
$leadform_file = __FILE__; 

if ( isset( $mu_plugin ) ) { 
    $leadform_file = $mu_plugin; 
} 
if ( isset( $network_plugin ) ) { 
    $leadform_file = $network_plugin; 
} 
if ( isset( $plugin ) ) { 
    $leadform_file = $plugin; 
} 

$GLOBALS['leadform_file'] = $leadform_file;


// Make sure class does not exist already.
if(!class_exists('Leadform')) :

    class LeadFormWidget extends WP_Widget {
        function LeadFormWidget() {
            parent::WP_Widget(false, 'Leadform Widget', array('description' => 'Description'));
        }

        function widget($args, $instance) {
            echo '<div id="leadform_widget"></div>';
        }
    ...
    function leadform_widget_register_widgets() {
        register_widget('LeadFormWidget');
    }
    ...
    class Leadform
    {
        ...
        */
        public function __construct($id)
        {
            ...
            */
            ...
            add_action('wp_footer', array(&$this, 'leadform_scripts'));
            ...
            add_action('widgets_init', 'leadform_widget_register_widgets');
        ...
        */
        ...
        /** function/method
        * Usage: helper for loading leadform.js
        * Arg(0): null
        * Return: void
        */
        public function leadform_scripts()
        {
            if (!is_admin()) {
                $options = $this->get_options();
                $secretkey = trim($options['secretkey']);
                $brandID = trim($options['brandID']);
                $this->show_leadform_reward_js($secretkey,$brandID);
            }
        }
        
        public function show_leadform_reward_js($secretkey="",$brandID="")
        {        	
            $bid = $brandID; 
            $secKey = $secretkey; 
        ...
        */
        public function options_page()
        {
            ...
            include('leadform_options_form.php');
        }
        /** function/method
        ...
        */
        public function menu()
        {
            ...
            add_menu_page('Leadform Options', 'Lead Form', 'manage_options',$this->plugin_id.'-plugin', array(&$this, 'options_page'),$icon,'80');
			
        }
    }

    // Instantiate the plugin
    $Leadform = new Leadform('leadform');
